...
#
#if(VCPKG_TARGET_IS_WINDOWS)
#  foreach(_pkg IN ITEMS gppcscconnectionplugin globalplatform)
#    foreach(_cfg IN ITEMS "" "debug/")
#      file(GLOB _target_files "${CURRENT_PACKAGES_DIR}/${_cfg}share/${_pkg}/*Targets*.cmake")
#      foreach(_targets IN LISTS _target_files)
#        vcpkg_replace_string("${_targets}" "/debug/lib/${_pkg}.dll" "/debug/bin/${_pkg}.dll")
#        vcpkg_replace_string("${_targets}" "/lib/${_pkg}.dll" "/bin/${_pkg}.dll")
#        vcpkg_replace_string("${_targets}" "\\debug\\lib\\${_pkg}.dll" "\\debug\\bin\\${_pkg}.dll")
#        vcpkg_replace_string("${_targets}" "\\lib\\${_pkg}.dll" "\\bin\\${_pkg}.dll")
#      endforeach()
#    endforeach()
